...
<div id="body" class="container-fluid">
	<div class="row pad-top">
		...
		<font size="5" type="bold">Todas as Postagens</font>
		...
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="col-lg-12 col-md-12 col-sm-8 col-xs-12 col-centered"> <!--barra de pesquisa -->
				<form method="post" name="pesquisa" action="pesquisar_post.php"> 
					<div class="form-group">
						<div class="input-group">
							<input type="text" class="form-control" name="busca" placeholder="pesquisar post"/>
	...
	<table class="table table-bordered">
		...
		echo"<tr>
			...
			<td>".$dados['curtidas']."</td>
			<td>
				<button class='btn btn-danger' onClick='Excluir(".$dados['id_post'].")'><img class='icone' src='../img/remove.png'></img></button>
...
<script>
	function Excluir(id_usuario){
		if(confirm("Tem certeza que deseja excluir esta postagem?")){
			pagina = '../post/excluir_post?id_post=' + id_usuario;
